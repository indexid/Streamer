// The idea of this component is to have a form that can be reused between to components: StreamCreate and StreamEdit.
...
class StreamForm extends React.Component {
  ...
  onSubmit = (formValues) => {
    // this.props.onSubmit() is a callback function that is going to be passed from a parent component.
...
export default reduxForm({ form: "streamForm", validate })(StreamForm); // We need to change the form name from streamCreate to streamFrom.

// StreamForm does't need to call any action creator. It's going to be a parent component that calls some action creator.
